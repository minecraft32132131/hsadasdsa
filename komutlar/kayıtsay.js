...
exports.run = async (client, message, args) => {
 ...
 //CodeArius
    let kayıtlılar = new Discord.MessageEmbed()
      ...
      .addField('<a:Rebilius_Og:760034833484611644>  __Erkek__', erkek, true) //CodeArius
      .addField('<a:Rebilius_Og:760034833484611644>  __Kız__', kız, true)
      .addField('<a:Rebilius_Og:760034833484611644> __Toplam__', toplam)
